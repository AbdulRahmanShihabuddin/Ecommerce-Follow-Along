...
//         `http://localhost:8080/getUserByEmail?userEmail=${userEmail}`,
//         {
//           method: "GET",
...
//         `http://localhost:8080/api/v1/profile/create`, // Adjust endpoint as needed
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
//           body: JSON.stringify({
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      const userResponse = await fetch(
        `http://localhost:8080/getUserByEmail?userEmail=${encodeURIComponent(userEmail)}`, // Encode to handle special characters
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
      ...
      const profileResponse = await fetch(
        `http://localhost:8080/api/v1/profile/getProfile?userId=${userId}`, // Use userId as query param
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
  ...
  const handleSubmitAddress = async (e) => {
    ...
    try {
      ...
      if (!profileResponse.ok || profileResponse.status === 404) {
        ...
        response = await fetch(
          `http://localhost:8080/api/v1/profile/addAddress`, // You’ll need to create this endpoint
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
